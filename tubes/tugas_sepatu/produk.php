...
// Query Tabel Sepatu ketika tombol dicari
if(isset($_GET['cari'])) {
  $keyword = $_GET['keyword'];
  $query = "SELECT * FROM tbl_dt_sepatu WHERE
...
<html lang="en">
        ...
        <div class="col-8">
          <form action="" method="GET">
            <div class="input-group mb-3">
              <input type="text" class="form-control" name="keyword" id="keyword" placeholder="Masukkan keyword pencarian..." autofocus>
  ...
  <?php foreach($sepatu as $spt) { ?>
    <tr class="align-middle">
      ...
      <td>
          <img src="img/<?php echo $spt["product_image"] ?>" width="75" class="rounded-circle">
      </td>
